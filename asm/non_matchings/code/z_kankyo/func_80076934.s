...
/* AEE76C 800775CC 3C028016 */  lui   $v0, %hi(gSaveContext+0x18)
/* AEE770 800775D0 03E00008 */  jr    $ra
/* AEE774 800775D4 8C42E678 */   lw    $v0, %lo(gSaveContext+0x18)($v0)

/* AEE778 800775D8 3C018016 */  lui   $at, %hi(gSaveContext+0x18)
/* AEE77C 800775DC 03E00008 */  jr    $ra
/* AEE780 800775E0 AC20E678 */   sw    $zero, %lo(gSaveContext+0x18)($at)

/* AEE784 800775E4 3C028016 */  lui   $v0, %hi(gSaveContext+0x14)
/* AEE788 800775E8 03E00008 */  jr    $ra
/* AEE78C 800775EC 8C42E674 */   lw    $v0, %lo(gSaveContext+0x14)($v0)

/* AEE790 800775F0 3C018016 */  lui   $at, %hi(gSaveContext+0x140e)
/* AEE794 800775F4 AFA40000 */  sw    $a0, ($sp)
/* AEE798 800775F8 03E00008 */  jr    $ra
/* AEE79C 800775FC A424FA6E */   sh    $a0, %lo(gSaveContext+0x140e)($at)
