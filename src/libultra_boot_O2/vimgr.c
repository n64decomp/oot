...
#ifndef NON_MATCHING
//padding should be automatically fixed when viMgrMain is going to match
#pragma GLOBAL_ASM("asm/non_matchings/boot/vimgr/pad_80008C90.s")
#endif
...
//order in which __osCurrentTime, __osBaseCounter and __osViIntrCount are loaded
#ifdef NON_MATCHING
