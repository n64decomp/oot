...
void func_801109B0(GlobalContext* globalCtx)
{
    ...
    func_800AA278(&interfaceCtx->view, globalCtx->gfxCtx);
    ...
    interfaceCtx->parameterSegment = Game_Alloc(globalCtx, parameterSize, "../z_construct.c", 159);
    ...
    interfaceCtx->do_actionSegment = Game_Alloc(globalCtx, 0x480, "../z_construct.c", 166);
    ...
    interfaceCtx->icon_itemSegment = Game_Alloc(globalCtx, 0x4000, "../z_construct.c", 190);
...
void func_80110F68(GlobalContext* globalCtx)
{
    ...
    func_800AA278(&msgCtx->view, globalCtx->gfxCtx);

    msgCtx->textboxSegment = Game_Alloc(globalCtx, 0x2200, "../z_construct.c", 349);
