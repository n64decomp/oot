...
static void BgSpot01Fusya_Draw(BgSpot01Fusya* this, GlobalContext* globalCtx)
{
    ...
    func_800C6AC4(gfxArr, globalCtx->gfxCtx, "../z_bg_spot01_fusya.c", 210);
    func_80093D18(globalCtx->gfxCtx);

    gSPMatrix(gfxCtx->polyOpa.p++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_bg_spot01_fusya.c", 214),
              G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    gSPDisplayList(gfxCtx->polyOpa.p++, &D_06000100);

    func_800C6B54(gfxArr, globalCtx->gfxCtx, "../z_bg_spot01_fusya.c", 219);
}
