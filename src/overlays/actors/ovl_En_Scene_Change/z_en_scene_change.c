...
{   
    ...
    displayList = Graph_Alloc(globalCtx->gfxCtx, 0x3C0);
    
    gfxCtx = globalCtx->gfxCtx;
  
    func_800C6AC4(gfxArr, globalCtx->gfxCtx, "../z_en_scene_change.c", 290);

    displayListHead = displayList;
    gSPSegment(gfxCtx->polyOpa.p++, 0x0C, displayListHead);

    func_80093D18(globalCtx->gfxCtx);
    func_800C6B54(gfxArr, globalCtx->gfxCtx, "../z_en_scene_change.c", 386);
}
