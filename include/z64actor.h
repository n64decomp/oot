...
typedef struct
{
    ...
    /* 0x08 */ u8 bodyFlags;
    /* 0x09 */ u8 unk_09[0x3]; /* 000000 */
    /* 0x0C */ s32 toucherMask; /* Attack Toucher Exclusion Mask */
    /* 0x10 */ u8 bumperEffect; /* Damage Effect (Knockback, Fire, etc.) */
    /* 0x11 */ u8 toucherDamage; /* Damage Amount or Stun Timer */
    /* 0x12 */ u8 unk_12[0x2]; /* 0000 */
    /* 0x14 */ s32 bumperMask; /* Bumper Exclusion Mask */
    /* 0x18 */ u8 unk_18[0x4]; /* 00000000 */
    /* 0x1C */ u8 toucherFlags; /* Attack Toucher Flags */
    /* 0x1D */ u8 bumperFlags; /* Bumper Flags */
    /* 0x1E */ u8 bodyFlags2;
    /* 0x1F */ u8 unk_1F; /* 00 */
} ColliderBodyInfo; // size = 0x20
...
typedef struct
{
    ...
    /* 0x20 */ s16 radius; /* Cylinder Radius */
    /* 0x22 */ s16 height; /* Cylinder Height */
    /* 0x24 */ s16 yShift; /* Shift Cylinder on Y Axis */
    /* 0x26 */ Vec3s position; /* {X, Y, Z} position of Cylinder */
