...
void func_800A46F8(GlobalContext* globalCtx, SkelAnime* skelAnime, u32 skeleton, u32 animation, u8 unk0, u8 unk1, u8 unk2);
// ? func_800A4A20(?);
// ? func_800A4AD8(?);
// ? func_800A4D9C(?);
// ? func_800A4EE0(?);
...
// ? func_800C546C(?);
// ? func_800C547C(?);
void* Game_Alloc(void* stateCtx, size_t size, char* file, s32 line);
// ? func_800C563C(?);
// ? func_800C5724(?);
// ? func_800C57CC(?);
// ? func_800C5834(?);
...
void Matrix_Softcv3Mult(Vec3f*, Vec3s*);
void Matrix_Softcv3Load(f32 x, f32 y, f32 z, Vec3s* vec);
Mtx* Matrix_MtxFToMtx(MtxF* src, Mtx* dest);
Mtx* Matrix_ToMtx(Mtx* dest, char* file, s32 line);
Mtx* Matrix_NewMtx(GraphicsContext* gfxCtx, char* file, s32 line);
Mtx* Matrix_MtxFToNewMtx(MtxF* src, GraphicsContext* gfxCtx);
void func_800D1AF4(Vec3f* src, Vec3f* dest);
void Matrix_MtxFCopy(MtxF* dest, MtxF* src);
void Matrix_MtxToMtxF(Mtx* src, MtxF* dest);
void func_800D1FA0(MtxF* mf);
void func_800D1FD4(MtxF* mf);
void func_800D20CC(MtxF* mf, Vec3f* vec, s32 flag);
void func_800D2264(MtxF* mf, Vec3f* vec, s32 flag);
void func_800D23FC(f32 f, Vec3f* vec, u8 mode);
MtxF* func_800D285C(MtxF* mf, char* file, s32 line);
