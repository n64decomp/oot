...
// ? func_80000B48(?);
s32 DmaMgr_CompareName(const char*, const char*);
s32 DmaMgr_DMARomToRam(u32, u32, u32);
s32 DmaMgr_DmaCallback0(OSPiHandle*, OSIoMesg*, s32);
void DmaMgr_DmaCallback1(u32, u32, u32);
void DmaMgr_Error(DmaRequest*, const char*, const char*, const char*);
const char* DmaMgr_GetFileNameImpl(u32);
const char* DmaMgr_GetFileName(u32);
void DmaMgr_ProcessMsg(DmaRequest*);
void DmaMgr_ThreadEntry(void*);
s32 DmaMgr_SendRequestImpl(DmaRequest*, u32, u32, u32, u32, OSMesgQueue*, OSMesg);
s32 DmaMgr_SendRequest0(u32, u32, u32);
void DmaMgr_Start();
s32 DmaMgr_SendRequest2(DmaRequest*, u32, u32, u32, u32, OSMesgQueue*, u32, const char*, s32);
s32 DmaMgr_SendRequest1(void*, u32, u32, const char*, s32);
// ? func_80001B30(?);
// ? func_80001BC8(?);
// ? func_80001CB0(?);
// ? func_80001E14(?);
...
void __assert(const char* mesg, const char* file, s32 line);
void isPrintfInit();
void osSyncPrintfUnused(const char*, ...);
void osSyncPrintf(const char*, ...);
void rmonPrintf(const char*, ...);
u32 is_proutSyncPrintf(void*, const char*, s32);
void func_80002384(const char*, const char*, u32);
// ? func_800023D0(?);
void StackCheck_Init();
void StackCheck_Cleanup(StackEntry*);
s32 StackCheck_GetState(StackEntry*);
u32 StackCheck_CheckAll();
u32 StackCheck_Check(StackEntry*);
float func_800029F0(const char*, s32, const char*, float, const char*, float, const char*, float);
s32 func_80002A88(const char*, s32, const char*, s32, const char*, s32, const char*, s32);
void func_80002B10(void*, s32);
void func_80002CB4(s32, u32, void*, const char*, const char*, s32);
void func_80002D04(const char*, s32, s32, const char*, s32);
void NullPointerCheck(const char*, void*, const char*, s32);
void func_80002DA0(const char*, void*, const char*, s32);
void SyncPrintfWithThreadId(const char*, s32);
void func_80002E50(const char*, s32);
void func_80002E9C();
char* proutSprintf(char* dst, const char *src, size_t size);
s32 vsnprintf(char*, const char*, va_list);
s32 snprintf(char*, const char*, ...);
// ? func_80002FA0(?);
// ? func_80002FF0(?);
// ? func_80003034(?);
...
// ? func_80005928(?);
// ? func_80005FC0(?);
s32 osEPiStartDma(OSPiHandle *, OSIoMesg *, s32 direction);
// ? func_800060B0(?);
// ? func_800060F0(?);
...
// ? func_800066E0(?);
UNK_TYPE bcmp(UNK_TYPE, UNK_TYPE, UNK_TYPE);
OSTime osGetTime();
// ? func_80006A70(?);
// ? func_80006AFC(?);
// ? func_80006C74(?);
...
UNK_TYPE func_80009270(UNK_TYPE, UNK_TYPE, UNK_TYPE);
UNK_TYPE func_800092E0(UNK_TYPE, UNK_TYPE, UNK_TYPE);
// ? func_80009310(?);
// ? func_80009320(?);
// ? func_800093F0(?);
// ? func_8001D234(?);
...
// ? func_8005B2AC(?);
// ? func_8005B65C(?);
UNK_TYPE func_8005B6A0(UNK_TYPE, UNK_TYPE);
// ? func_8005B6B0(?);
// ? func_8005B6EC(?);
// ? func_8005B72C(?);
// ? func_8005B76C(?);
...
// ? func_8005B79C(?);
// ? func_8005B7C0(?);
UNK_TYPE func_8005B7E4(UNK_TYPE, UNK_TYPE);
// ? func_8005B7F4(?);
void func_8005B818(UNK_TYPE, UNK_TYPE);
// ? func_8005B824(?);
UNK_TYPE func_8005B850(UNK_TYPE, UNK_TYPE);
// ? func_8005B860(?);
// ? func_8005B884(?);
// ? func_8005B904(?);
// ? func_8005B93C(?);
...
// ? func_8005BA1C(?);
// ? func_8005BA30(?);
UNK_TYPE func_8005BA74(UNK_TYPE, UNK_TYPE);
// ? func_8005BA84(?);
// ? func_8005BAD8(?);
// ? func_8005BB10(?);
// ? func_8005BB48(?);
...
// ? func_8005BBD4(?);
// ? func_8005C2BC(?);
UNK_TYPE func_8005C318(UNK_TYPE, UNK_TYPE);
// ? func_8005C328(?);
...
// ? func_8005C5B0(?);
UNK_TYPE func_8005C5F8(UNK_TYPE, UNK_TYPE);
// ? func_8005C608(?);
// ? func_8005C6C0(?);
// ? func_8005C6F8(?);
// ? func_8005C730(?);
...
// ? func_8005C7BC(?);
// ? func_8005CE6C(?);
UNK_TYPE func_8005CEB4(UNK_TYPE, UNK_TYPE);
// ? func_8005CEC4(?);
// ? func_8005CEDC(?);
// ? func_8005CF90(?);
// ? func_8005D160(?);
...
s32 func_8008F0D8(Player*, UNK_TYPE);
// ? func_8008F104(?);
s32 func_8008F158(UNK_TYPE);
// ? func_8008F180(?);
// ? func_8008F1A0(?);
// ? func_8008F1CC(?);
s32 func_8008F224(UNK_TYPE, UNK_TYPE);
s32 func_8008F270(UNK_TYPE, UNK_TYPE);
// ? func_8008F29C(?);
// ? func_8008F2F8(?);
// ? func_8008F470(?);
// ? func_8008F87C(?);
...
// ? func_800BC450(?);
// ? func_800BC490(?);
UNK_TYPE func_800BC56C(GlobalContext*, s16);
// ? func_800BC5E0(?);
