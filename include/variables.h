...
extern u8 sBootThreadInfo[0x20];
extern OSThread sBootThread;
extern u8 sIdleThreadStack[0x400];
extern u8 sIdleThreadInfo[0x20];
...
extern u16 gFrameBuffers[2][0x9208]; // 0x24820 bytes
