...
//todo remove? this is seemingly unused and was causing warnings
/*
...
typedef struct
{
	...
	s16 numCameras;             // 0x04
	s32 cameraPositionDataSeg;  // 0x08
    u32 unk;                    // 0x0C
} _CamData;
...
enum SCENES
{
    ...
    SCENE_HIDAN, // 0x04
    SCENE_MIZUSIN, // 0x05
    SCENE_JYASINZOU, // 0x06
    SCENE_HAKADAN, // 0x07
    SCENE_HAKADANCH, // 0x08
    SCENE_ICE_DOUKUTO, // 0x09
    SCENE_GANON, // 0x0A
    SCENE_MEN, // 0x0B
    SCENE_GERUDOWAY, // 0x0C
    SCENE_GANONTIKA, // 0x0D
    SCENE_GANON_SONOGO, // 0x0E
    SCENE_GANONTIKA_SONOGO, // 0x0F
    SCENE_TAKARAYA, // 0x10
    SCENE_YDAN_BOSS, // 0x11
    SCENE_DDAN_BOSS, // 0x12
    SCENE_BDAN_BOSS, // 0x13
    SCENE_MORIBOSSROOM, // 0x14
    SCENE_FIRE_BS, // 0x15
    SCENE_MIZUSIN_BS, // 0x16
    SCENE_JYASINBOSS, // 0x17
    SCENE_HAKADAN_BS, // 0x18
    SCENE_GANON_BOSS, // 0x19
    SCENE_GANON_FINAL, // 0x1A
    SCENE_ENTRA, // 0x1B
    SCENE_ENTRA_N, // 0x1C
    SCENE_ENRUI, // 0x1D
    SCENE_MARKET_ALLEY, // 0x1E
    SCENE_MARKET_ALLEY_N, // 0x1F
    ...
    SCENE_SHRINE_N, // 0x24
    SCENE_SHRINE_R, // 0x25
    SCENE_KOKIRI_HOME, // 0x26
    SCENE_KOKIRI_HOME3, // 0x27
    SCENE_KOKIRI_HOME4, // 0x28
    SCENE_KOKIRI_HOME5, // 0x29
    SCENE_KAKARIKO, // 0x2A
    SCENE_KAKARIKO3, // 0x2B
    SCENE_SHOP1, // 0x2C
    SCENE_KOKIRI_SHOP, // 0x2D
    SCENE_GOLON, // 0x2E
    SCENE_ZOORA, // 0x2F
    SCENE_DRAG, // 0x30
    SCENE_ALLEY_SHOP, // 0x31
    SCENE_NIGHT_SHOP, // 0x32
    SCENE_FACE_SHOP, // 0x33
    SCENE_LINK_HOME, // 0x34
    SCENE_IMPA, // 0x35
    SCENE_MALON_STABLE, // 0x36
    SCENE_LABO, // 0x37
    SCENE_HYLIA_LABO, // 0x38
    SCENE_TENT, // 0x39
    SCENE_HUT, // 0x3A
    SCENE_DAIYOUSEI_IZUMI, // 0x3B
    SCENE_YOUSEI_IZUMI_TATE, // 0x3C
    SCENE_YOUSEI_IZUMI_YOKO, // 0x3D
    SCENE_KAKUSIANA, // 0x3E
    SCENE_HAKAANA, // 0x3F
    SCENE_HAKAANA2, // 0x40
    SCENE_HAKAANA_OUKE, // 0x41
    SCENE_SYATEKIJYOU, // 0x42
    SCENE_TOKINOMA, // 0x43
    SCENE_KENJYANOMA, // 0x44
    SCENE_HAIRAL_NIWA, // 0x45
    SCENE_HAIRAL_NIWA_N, // 0x46
    SCENE_HIRAL_DEMO, // 0x47
    SCENE_HAKASITARELAY, // 0x48
    SCENE_TURIBORI, // 0x49
    SCENE_NAKANIWA, // 0x4A
    SCENE_BOWLING, // 0x4B
    SCENE_SOUKO, // 0x4C
    SCENE_MIHARIGOYA, // 0x4D
    SCENE_MAHOUYA, // 0x4E
    SCENE_GANON_DEMO, // 0x4F
    SCENE_KINSUTA, // 0x50
    SCENE_SPOT00, // 0x51
    SCENE_SPOT01, // 0x52
    SCENE_SPOT02, // 0x53
